...
#ifndef BACKTRACE_MODEL_H
#define BACKTRACE_MODEL_H
...
public:
    ...
    BacktraceDecorationCache* backtraceDecorationCache() const;
...
private:
    ...
    BacktraceDecorationCache *const m_backtraceCache;
};
